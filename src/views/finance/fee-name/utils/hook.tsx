  ...
  function openDialog(title = "添加", row?: FormItemProps) {
    addDialog({
      ...
      beforeSure: (done, { options }) => {
        ...
        function chores() {
          message(`您${title}了费用名称为${curData.name}的这条数据`, {
            type: "success"
          });
          done(); // 关闭弹框
          onSearch(); // 刷新表格数据
